var template = (name, code, url) => `<!DOCTYPE html>
<html>
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
  <meta name="viewport" content="width=device-width" />
  <title>Smart GreenHouse Welcome</title>
  <style type="text/css">
            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title">Welcome to Smart GreenHouse Go!</td>
                    </tr>
                  </table>
                        ...
                        <table class="status" bgcolor="#fffeea" cellspacing="0">
                          <tr>
                            <td class="status-cell">
                              Your active code is valid for 5 minutes: <b>${code}</b>
                            </td>
                          </tr>
                        </table>
                      </td>
                        ...
                        <table class="body-signature-block">
                          <tr>
                            <td class="body-signature-cell">
                              <p>Thanks so much,</p>
                              <p class="body-signature"><img src="https://www.filepicker.io/api/file/2R9HpqboTPaB4NyF35xt" alt="Smart GreenHouse"></p>
                            </td>
                          </tr>
                        </table>
                      </td>
      ...
      <tr>
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>@Copyright by Stephen</b></a> 
          </div>
        </td>
      </tr>
    </table>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="footer-group">
              <a href="https://facebook.com/attackedbyneo">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="#">Twitter</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="#">Support</a>
            </span>
          </div>
